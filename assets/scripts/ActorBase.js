  ...
  (function (t) {
    ...
    e.prototype.setHp = function (t) {
      ...
      if (this._head) {
        this._head.updateHP(
          this._hp,
          this._actorAttribute.getNumeric($attrEnum.E_AttrType.HP).value,
        );
      }
    };
    ...
    e.prototype.onBeforeHurt = function (t) {
      $eventManager.EventManager.instance.emit(
        $actorEnum.EActorEvent.BEFORE_BE_HURT + this._unitId,
        t,
        this,
      );
    };
    e.prototype.onBeHurt = function (t) {
      $eventManager.EventManager.instance.emit(
        $actorEnum.EActorEvent.BE_HURT + this._unitId,
        t,
        this,
      );
