...
var d = (function (t) {
  ...
  e.prototype.onUpdateItem = function (t, e) {
    ...
    if (this._isDropTips) {
      ...
      o.getComponent(cc.Label).string = u.info.replace(
        "|val|",
        u.changeID.toString(),
      );
  ...
  e.prototype.onBtnShed = function (t) {
    if (this._isDropTips) {
      ...
      this.mBtnEnemy.getChildByName("lab").color = new cc.Color().fromHEX(
        "#959C7B",
      );
      this._isDropTips = !0;
      this.setList();
  ...
  e.prototype.onBtnEnemy = function (t) {
    if (this._isDropTips) {
      ...
      this.mBtnShed.getChildByName("lab").color = new cc.Color().fromHEX(
        "#959C7B",
      );
      this._isDropTips = !1;
      this.setList();
