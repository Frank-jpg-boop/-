...
var o = (function () {
  ...
  t.prototype.computeNewVelocity = function (t) {
    ...
    for (
      var e = this.orcaLines_, n = 1 / this.timeHorizonObst, o = 0;
  ...
  t.prototype.insertAgentNeighbor = function (t, e) {
    if (this != t) {
      ...
      if (n < e) {
        ...
        for (
          var o = this.agentNeighbors_.length - 1;
  ...
  t.prototype.insertObstacleNeighbor = function (t, e) {
    var n = t.next;
    var o = $common.RVOMath.distSqPointLineSegment(
      t.point,
      n.point,
      this.position_,
    );
    if (o < e) {
      ...
      for (
        var r = this.obstaclNeighbors_.length - 1;
