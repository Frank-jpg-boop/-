...
var C = (function () {
  ...
  t.prototype.getCommonSkillExProbRate = function () {
    ...
    var e = $cfg.default.instance.dataCons
      .getById(102)
      .val.split("|")
      .map(Number);
    var n = e[0];
  ...
  t.prototype.refreshSkillExIds = function (t) {
    var e = this;
    var n = 0 == t;
    var o = $attrMgr.AttrMgr.instance.getPlayerAttrValue(
    ...
    for (
      var v = n ? this.getCommonSkillExProbRate() : 1;
      c.length > 0 && d > 0;
    ) {
      m = c.map(function (t) {
  ...
  t.prototype.hasSkillEx = function () {
    for (
      var t = function (t) {
          var n = $cfg.default.instance.dataSkill.getById(
