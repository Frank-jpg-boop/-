      ...
      return __generator(this, function (i) {
        switch (i.label) {
          case 0:
            if (
              "" ==
              (t = $sqlUtil.SqlUtil.getLocalUserData(
          ...
          case 2:
            ...
            if ("" != $userCenterMgr.UserCenterMgr.instance.playerId) {
              ...
              if (
                "" ==
                (n = $sqlUtil.SqlUtil.getLocalUserData(
                  $userDataProxy.userDataProxy.uidKey,
                  "",
                ))
              ) {
            ...
            $dataMgr.DataMgr.instance.init(
              n,
              $userCenterMgr.UserCenterMgr.instance.svrData,
            );
      ...
      return __generator(this, function () {
        if (yzll.gameConfig.isZB) {
          return [
            2,
            new Promise(function (n) {
              $userCenterMgr.UserCenterMgr.instance.zbActiveState(
                t,
                function () {
                  console.log(
                    "主播状态:",
                    $userCenterMgr.UserCenterMgr.instance.zbState,
                  );
