...
e.prototype.aniDelItem = function (t, e, n) {
  ...
  if (r) {
    ...
    const a = i.displayData[i.displayData.length - 1].id;
    const s = o.selected;
    o.showAni(
      n,
      function () {
        ...
        if (i.selectedMode == c.SINGLE) {
          ...
          const p = i.multSelected.indexOf(t);
          if (p >= 0) {
            i.multSelected.splice(p, 1);
          }
          for (const h = i.multSelected.length - 1; h >= 0; h--) {
...
e.prototype._delRedundantItem = function () {
  if (this._virtual) {
    for (const t = this._getOutsideItem(), e = t.length - 1; e >= 0; e--) {
      const n = t[e];
      if (!this._scrollItem || n._listId != this._scrollItem._listId) {
        n.isCached = !0;
        this._pool.put(n);
        for (const i = this._lastDisplayData.length - 1; i >= 0; i--) {
...
e.prototype._getOutsideItem = function () {
  for (let t, e = [], n = this.content.childrenCount - 1; n >= 0; n--) {
...
e.prototype.getItemByListId = function (t) {
  if (this.content) {
    for (const e = this.content.childrenCount - 1; e >= 0; e--) {
      const n = this.content.children[e];
      if (n._listId == t) {
        return n;
      }
    }
...
e.prototype.updateItem = function (t) {
  if (this.checkInited()) {
    ...
    for (const e = 0, n = t.length; e < n; e++) {
      const i = t[e];
...
e.prototype._updateItemPos = function (t) {
  ...
  const n = this.getItemPos(e._listId);
...
e.prototype._createOrUpdateItem2 = function (t) {
  let e;
  const n = this.content.children[t];
  if (n) {
...
e.prototype._createOrUpdateItem = function (t) {
  const e = this.getItemByListId(t.id);
  if (e) {
    if (this._forceUpdate && this.renderEvent) {
    ...
    if (n && this._needUpdateWidget) {
      const i = e.getComponent(cc.Widget);
      if (i) {
        i.updateAlignment();
      }
    }
    e.setSiblingIndex(this.content.childrenCount - 1);
    const o = e.getComponent($listItem.default);
    e.listItem = o;
    if (o) {
      o.listId = t.id;
      o.list = this;
...
e.prototype._pageAdhere = function () {
  ...
  if (
    ...
    const n = (t._sizeType ? t.node.height : t.node.width) * t.pageDistance;
...
e.prototype._onScrollEnded = function () {
  ...
  if (null != t.scrollToListId) {
    const e = t.getItemByListId(t.scrollToListId);
...
e.prototype._calcExistItemPos = function (t) {
  const e = this.getItemByListId(t);
  if (!e) {
    return null;
  }
  const n = {
...
e.prototype._calcItemPos = function (t) {
  ...
  switch (this._align) {
    ...
    case cc.Layout.Type.GRID:
      const p = Math.floor(t / this._colLineNum);
...
e.prototype._calcViewPos = function () {
  const t = this.content.getPosition();
  ...
  if (
    ...
    if (this._virtual) {
      ...
      if (this._customSize) {
        ...
        const f = this._itemSize.height + this._lineGap;
        switch (this._alignCalcType) {
          case 1:
            l = (s - this._leftGap) / h;
            u = (r - this._leftGap) / h;
      ...
      const d = this._lastDisplayData.length;
      const m = this.displayItemNum != d;
      if (m) {
      ...
      if (this._forceUpdate || m) {
        if (this.frameByFrameRenderNum > 0) {
          ...
          for (const y = 0; y < this.displayItemNum; y++) {
  ...
  switch (e._align) {
    ...
    case cc.Layout.Type.VERTICAL:
      if (e._customSize) {
        ...
        t =
          e._topGap +
          e._itemSize.height * e._numItems +
          e._lineGap * (e._numItems - 1) +
          e._bottomGap;
      }
      break;
...
e.prototype.setTemplateItem = function (t) {
  if (t) {
    ...
    const n = t.getComponent($listItem.default);
    const i = !1;
    if (n) {
      //
    } else {
...
e.prototype._processAutoScrolling = function (t) {
  ...
  const i = this._scrollView._autoScrollStartPosition.add(
    this._scrollView._autoScrollTargetDelta.mul(e),
  );
  const o = this._scrollView.getScrollEndedEventTiming();
  const r = Math.abs(e - 1) <= o;
  if (
  ...
  set: function (t) {
    ...
    if (e.checkInited(!1)) {
      if (null == t || t < 0) {
        ...
        const n = e.content.getComponent(cc.Layout);
        if (n) {
          n.enabled = !0;
        }
        e._delRedundantItem();
    ...
    switch (n.selectedMode) {
      case c.SINGLE:
        ...
        if (n._lastSelectedId >= 0 && n._lastSelectedId != n._selectedId) {
          const o = n.getItemByListId(n._lastSelectedId);
          if (o) {
      ...
      case c.MULT:
        ...
        const r = !i.selected;
        i.selected = r;
        const a = n.multSelected.indexOf(t);
        if (r && a < 0) {
