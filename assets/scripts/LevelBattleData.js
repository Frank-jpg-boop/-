...
var p = (function () {
  ...
  Object.defineProperty(t.prototype, "skillExMap", {
    get: function () {
      for (
        var t = new Map(), e = 0, n = Object.entries(this._data.skillExDataMap);
        e < n.length;
        e++
      ) {
        var i = n[e];
  ...
  Object.defineProperty(t.prototype, "enemyLevelRate", {
    get: function () {
      var t = $stageDataProxy.stageDataProxy.getStageSurvivalCount(
  ...
  t.prototype.init = function (t) {
    ...
    var n = $cfg.default.instance.dataSkin.getById(
