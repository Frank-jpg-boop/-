  ...
  (function (t) {
    ...
    e.prototype.registerState = function () {
      ...
      this._sm.addState(
        ...
        new $playerAttackState.PlayerAttackState(this),
      );
      this._sm.addState(
        $actorEnum.EActorStateType.DEAD,
        new $playerDeadState.PlayerDeadState(this),
      );
      this._sm.addState(
        $actorEnum.EActorStateType.EXTEND_1,
        new $playerBeDragState.PlayerBeDragState(this),
      );
    };
    e.prototype.registerEvent = function () {
      $eventManager.EventManager.instance.on(
        $joystick.EJoystickEvent.TOUCH_MOVE,
        this.onJoystickMove,
        this,
      );
      $eventManager.EventManager.instance.on(
        $joystick.EJoystickEvent.TOUCH_END,
        this.onJoystickEnd,
        this,
      );
      $eventManager.EventManager.instance.on(
    ...
    e.prototype.moveInPoint = function (t, e) {
      ...
      if (null != s) {
        if (
          this.moveDir &&
          (s.dir.x != this.moveDir.x || s.dir.y != this.moveDir.y) &&
          !this._isSlide
        ) {
          this._isSlide = !0;
        ...
        if (
          m.isInPoint(
            ...
            this.getAttribute($attrEnum.E_AttrType.SPEED).value * e - 0.1,
          )
        ) {
          this.moveDir = null;
          this._moveTargetPointId = "";
