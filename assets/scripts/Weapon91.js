...
const d =
  ...
  (function (t) {
    ...
    e.prototype.play = function (t, e, n) {
      ...
      const o = e
        .sub(
          $nodeUtil.default.nodeParentChangeLocalPos(this.node, this._ownerSkill.owner.node.parent),
        )
        .normalize();
    ...
    e.prototype.fire = function (t) {
      ...
      for (
        const n = this._ownerSkill.getAttribute($attrEnum.E_SkillAttrType.EXTRA_ATTR_6).value,
          i = (180 * Math.atan2(t.y, t.x)) / Math.PI,
          o = n >> 1,
          r = function (t) {
            const n = i + 10 * (t - o);
            const r = cc.v2(Math.cos((n * Math.PI) / 180), Math.sin((n * Math.PI) / 180));
