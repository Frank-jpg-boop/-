...
e.prototype.update = function (t) {
  if (this._context.moveDir && !this._context.isSlide) {
    const e = $mathUtil.MathUtil.vec2Fixed(this._context.node.getPosition());
    const n = this._context.getAttribute($attrEnum.E_AttrType.SPEED).value;
    const i = $mathUtil.MathUtil.vec2Fixed(this._context.moveDir.mul(n * t));
    const o = e.add(i);
