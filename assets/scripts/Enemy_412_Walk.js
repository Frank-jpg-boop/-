...
let i;
export const Enemy_412_Walk = void 0;
...
e.prototype.findWalkTargetPos = function (t) {
  for (
    ...
    if ('' == this._context.pathPointId || this._context.pathPointId != c) {
      ...
      const u = cc.Vec2.squaredDistance(l.pos, this._context.node.getPosition());
      if (u < o && n < u) {
        o = u;
...
e.prototype.updateFindTarget = function () {
  ...
  if (e && !e.isDead()) {
    const n = cc.Vec2.squaredDistance(e.node.getPosition(), this._context.node.getPosition());
