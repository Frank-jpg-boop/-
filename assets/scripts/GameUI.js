...
var j = (function (t) {
  ...
  e.prototype.start = function () {
    var t = this;
    this._isPopupBack = !1;
    $battleMgr.default.instance.switchScene(
      $battleEnum.EBattleSceneType.LEVEL,
      function () {
  ...
  e.prototype.onEventPickupFlyGood = function (t, e, n) {
    if (1 != t) {
      if (900 != t) {
        "" == $cfg.default.instance.dataReward.getById(t).boxObj ||
          this.pickupFlyBagCommon(t, e, n);
      } else {
  ...
  e.prototype.pickupFlyElectric = function (t) {
    ...
    if (o) {
      ...
      var s = $nodeUtil.default.nodeParentChangeLocalPos(
        this.electricItem.node,
        this.nFly,
      );
      var c = n.getPosition();
      var f = s;
      ...
      var i = this,
        ...
        r = function (e) {
          ...
          s.scheduleOnce(function () {
            ...
            var c = $battleMgr.default.instance
              .getCurScene()
            ...
            cc.tween(e)
              .bezierTo(0.6, d, _, y)
              .call(function () {
                e.getChildByName("Icon").getComponent(cc.Sprite).spriteFrame =
                  null;
                ...
                if (
                  $levelBattleData.levelBattleData.data.bagItemRecord.has(t)
                ) {
                  //
                } else {
      ...
      var i = this,
        ...
        c = function (t) {
          ...
          p.scheduleOnce(function () {
            ...
            t.setPosition(
              s.convertToNodeSpaceAR(r.cameraCtrl.uiWorldPosToGameWorldPos(f)),
            );
  ...
  e.prototype.updateBagView = function () {
    var t = $actorMgr.default.instance.getActor(
      $battleMgr.default.instance.getCurScene().playerId,
    );
    var e = $unitMgr.UnitMgr.instance
    ...
    this.nBag
      ...
      .getComponent(cc.Label).string = n.toString();
  };
  ...
  e.prototype.onEventSetFullBagState = function (t) {
    ...
    if (e.active != t && ((e.active = t), t)) {
      ...
      cc.tween(n)
        ...
        .call(function () {})
        .start();
      n.getChildByName("BtnEx").active =
        !$levelBattleData.levelBattleData.bagData.isUnlock;
    }
  };
  e.prototype.showBackConfirm = function () {
    if (
      ...
      if (t) {
        ...
        if (
          e &&
          !(t.isWaitRescue || t.isRescue || e.isDead() || this._isPopupBack)
        ) {
          this._isPopupBack = !0;
  ...
  e.prototype.onClickBtnSet = function () {
    $globalPopupMgr.default.instance.showLevelSet(
