...
e.prototype.onPlayerPassDoor = function (t) {
  const e = this;
  const n = this.getAttribute($attrEnum.E_SkillAttrType.EXTRA_ATTR_6).value;
...
e.prototype.removeWeapon = function (t) {
  const e = this._weapons.indexOf(t);
  if (e >= 0) {
...
e.prototype.checkLine = function (t, e) {
  ...
  if (e) {
    ...
    const i = t.node.getPosition();
    const o = this.getAttribute($attrEnum.E_SkillAttrType.EXTRA_ATTR_5).value;
...
e.prototype.summonWeapon = function () {
  const t = this;
  this.enterCD();
  const e = cc.v2(30 * -this._owner.dirX, 0.7 * this._owner.rightHeight);
  const n = this._owner.node.getPosition().add(e);
