...
t.prototype.isPointInBoundingBox = function (t, e) {
  ...
  const n = Math.min(this._point1Pos.x, this._point2Pos.x) - e;
  const i = Math.max(this._point1Pos.x, this._point2Pos.x) + e;
  const o = Math.min(this._point1Pos.y, this._point2Pos.y) - e;
  const r = Math.max(this._point1Pos.y, this._point2Pos.y) + e;
...
t.prototype.init = function (t, e, n) {
  ...
  const o = this._point2Pos.sub(this._point1Pos);
  this._len = o.len();
