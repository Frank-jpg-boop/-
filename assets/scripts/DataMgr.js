...
var S = (function () {
  ...
  t.prototype.initLocalData = function (t) {
    var e;
    var n = $sqlUtil.SqlUtil.getLocalUserData(
  ...
  t.prototype.initPlayerData = function () {
    var t = new $playerDataProxy.PlayerData(
  ...
  t.prototype.initItemData = function () {
    var t = new $itemDataProxy.ItemData(
  ...
  t.prototype.initStageData = function () {
    var t = new $stageDataProxy.StageData(
  ...
  t.prototype.initGuideData = function () {
    var t = new $guideDataProxy.GuideData(
  ...
  t.prototype.initTaskData = function () {
    var t = new $taskDataProxy.TaskData(
  ...
  t.prototype.initSignData = function () {
    var t = new $signDataProxy.SignData(
