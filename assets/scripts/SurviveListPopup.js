...
var S = (function (t) {
  ...
  e.prototype.initSelectBtn = function () {
    ...
    for (
      var o = $stageDataProxy.stageDataProxy.passStageId, r = 1;
      r <= 3;
      ++r
    ) {
  ...
  e.prototype.onReceivePeopleItemClick = function (t, e) {
    ...
    $globalPopupMgr.default.instance.showOpenBoxPopup(1, function () {
      var t = $playerDataProxy.playerDataProxy.getBoxReward(
        e.peopleData.reward,
      );
  ...
  e.prototype.showRewardInfo = function (t, e) {
    ...
    var r = $nodeUtil.default.nodeParentChangeLocalPos(
      e,
