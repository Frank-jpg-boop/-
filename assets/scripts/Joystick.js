...
e.prototype.setSafePos = function (t) {
  const e = this;
  const n = e.node.width / 2;
  const i = e.node.height / 2;
  const o = e.node.parent.width - n;
  const r = e.node.parent.height - i;
  if (t.x < n) {
    t.x = n;
  } else {
    if (t.x > o) {
...
e.prototype.onTouchMove = function (t) {
  ...
  if (e && e.isPlay) {
    const n = this;
    const i = n.node.convertToNodeSpaceAR(t.getLocation());
    const o = i.lengthSqr();
    const r = n.node.width / 2;
    if (0 == i.x && 0 == i.y) {
      n._radian = 0;
    } else {
      n._radian = cc.v2(1, 0).signAngle(i);
    }
    const a = Math.cos(n._radian) * r;
    const s = Math.sin(n._radian) * r;
...
e.prototype.onTouchStart = function (t) {
  ...
  if (n && n.isPlay) {
    ...
    this.node.active = !0;
    e.isTouchJoystick = !0;
    const i = e.node.parent.convertToNodeSpaceAR(t.getLocation());
    e.setSafePos(i);
    const o = e.node.convertToNodeSpaceAR(t.getLocation());
    const r = o.len();
    const u = e.node.width / 2;
    if (0 == o.x && 0 == o.y) {
      e._radian = 0;
    } else {
      e._radian = cc.v2(1, 0).signAngle(o);
    }
    const p = Math.cos(e._radian) * u;
    const h = Math.sin(e._radian) * u;
    this._vec2 = cc.v2(0, 0);
