...
var S = (function (t) {
  ...
  e.prototype.canGetOnlineReward = function () {
    var t = $cfg.default.instance.dataMerchant.getById(
  ...
  e.prototype.getOnlineReward = function (t) {
    var e = $cfg.default.instance.dataMerchant.getById(
      this._data.localData.onlineRewardId + 1,
    );
  ...
  e.prototype.setDscountGoodsBuyNum = function (t, e) {
    var n = this._data.localData.dscountShopData.goodsDatas.findIndex(
      function (e) {
        return e.cfgId == t;
      },
    );
  ...
  e.prototype.getDscountGoodsBuyNum = function (t) {
    var e = this._data.localData.dscountShopData.goodsDatas.findIndex(
      function (e) {
        return e.cfgId == t;
      },
    );
  ...
  e.prototype.getArtifactUpGreadNeedNum = function (t) {
    var e = $cfg.default.instance.dataSkill.getById(t).cost.split("|")[
  ...
  e.prototype.updateSurviveRewardRedPoint = function () {
    for (
      var t = $stageDataProxy.stageDataProxy.passStageId, e = !1, n = 1;
      n <= t + 1;
      ++n
    ) {
  ...
  e.prototype.updateStageExploreRedPoint = function () {
    for (
      var t = !1, e = $stageDataProxy.stageDataProxy.passStageId, n = 1;
      n <= e + 1;
      ++n
    ) {
  ...
  e.prototype.updateSkinRedPoint = function () {
    ...
    if (!t && e) {
      for (
        var n = $cfg.default.instance.dataSkin.sheet(), i = 0;
        i < n.length;
        ++i
      ) {
