...
var s = (function () {
  ...
  t.GetCoinStringDot = function (t, e, n) {
    ...
    for (
      var s = this.coinType[a], c = Math.min(o.length, 2), l = 0;
      l < c;
      l++
    ) {
      var u = Number(o[l]);
  ...
  t.sort = function (t, e, n, a) {
    ...
    if (r.BUBBLE === a) {
      for (var s = (b = t.length), c = 0; c < b; c++) {
        for (
          var l = t[0] && e ? t[0][e] : t[0] || 0, u = !0, p = s - 1, h = 0;
          h < p;
          h++
        ) {
          var f = null;
  ...
  t.weightedRandom = function (t) {
    ...
    for (
      var n = $randomUtil.RandomUtil.randomInt(0, e), i = 0;
      i < t.length;
      ++i
    ) {
      if (n < t[i]) {
  ...
  t.getCirclePoints = function (t, e, n, i) {
    ...
    for (
      var o = [], r = (Math.PI / 180) * Math.round(360 / n), a = 0;
      a < n;
      a++
    ) {
      var s = Math.sin(r * a);
