...
var _ = (function (t) {
  ...
  e.prototype.updateSwitchView = function () {
    ...
    this.nGMSwitch.children[1].getComponent(cc.Toggle).isChecked =
      $battleMgr.default.instance.gm_InfiniteRandom;
    this.nGMSwitch.children[2].getComponent(cc.Toggle).isChecked =
    ...
    $globalPopupMgr.default.instance.showGMInput(
      ...
      function (t) {
        ...
        if ("" == e || isNaN(Number(e)) || isNaN(Number(t[1]))) {
          ...
          var n = Number(e);
          var i = Number(t[1]);
          var o = $battleMgr.default.instance
            .getCurScene()
            .level.getRoomById(n);
          if (o) {
