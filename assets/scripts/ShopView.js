...
var A = (function (t) {
  ...
  e.prototype.updateDiamondNum = function () {
    ...
    var n = $itemDataProxy.itemDataProxy.getItemValue(
      $itemEnum.E_ItemId.DIAMOND,
    );
    if (e) {
    ...
    if (!t && $playerDataProxy.playerDataProxy.dscountGoodsDatas.length > 0) {
      ...
      for (var r in ((e = o[s]), i)) {
        ...
        if (1 == c.buyType) {
          ...
          var S = $cfg.default.instance.dataItem
            .getById(Number(y[1]))
            .val.split("|")
            .map(Number);
  ...
  e.prototype.refreshDscountShopItem = function () {
    for (
      var t = $playerDataProxy.playerDataProxy.dscountGoodsDatas,
  ...
  e.prototype.onDscountShopBtnBuy = function (t, e) {
    ...
    var n = $playerDataProxy.playerDataProxy.getDscountGoodsBuyNum(
      e.goodsData.cfgId,
    );
    n += 1;
  ...
  e.prototype.getBoxReward = function (t, e) {
    ...
    for (
      var i = (t ? e.bigReward : e.reward).split("|"), o = [], r = 0;
      r < i.length;
      ++r
    ) {
      for (
  ...
  e.prototype.setGoldItemData = function (t, e) {
    ...
    if (1 == e.buyType) {
      ...
      var f = $itemDataProxy.itemDataProxy.getItemValue(
        $itemEnum.E_ItemId.DIAMOND,
      );
      if (f >= h) {
  ...
  e.prototype.onBuyGoldItem = function (t, e) {
    ...
    if (1 == e.goldData.buyType) {
      ...
      var o = $itemDataProxy.itemDataProxy.getItemValue(
        $itemEnum.E_ItemId.DIAMOND,
      );
