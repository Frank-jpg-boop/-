...
var v = (function (t) {
  ...
  e.prototype.onDefaultAnimFrameEvent = function (t, e) {
    if ("atk" == t && "atk" == e) {
      for (
        var n = $nodeUtil.default.nodeParentChangeLocalPos(
            this.node,
      ...
      for (var f = 0, d = o; f < d.length; f++) {
        ...
        if (
          ...
          var y = $battleHurtFormulaMgr.default.instance.skillHurt(
  ...
  e.prototype.onRemove = function () {
    ...
    var o = this._ownerSkill.getAttribute(
  ...
  __decorate(
    [g($simplyCircleCollider.default)],
    e.prototype,
    "collider",
    void 0,
  );
