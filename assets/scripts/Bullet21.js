...
var y = (function (t) {
  ...
  e.prototype.updateSize = function () {
    var t = this._ownerSkill.getAttribute(
  ...
  e.prototype.checkCollision = function () {
    ...
    t.y += this.node.y;
    for (
      var e = $gridAreaDivisionMgr.default.instance.getRectAreaKeys(t),
        n = [],
        i = 0,
        o = e;
      i < o.length;
      ...
      if (y.canBeHurt()) {
        if (
          ...
          if (!this._collisionIds.includes(y.unitId)) {
            ...
            var _ = $battleHurtFormulaMgr.default.instance.skillHurt(
            ...
            y.beHurt(_);
            var g = this._ownerSkill.getAttribute(
