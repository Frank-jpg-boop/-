...
t.prototype.init = function (t, e) {
  ...
  const i = this.textNode.addComponent(cc.Label);
  ...
  const o = 1 + ~~((e.length * i.fontSize) / ((3 * n) / 5));
  this.textNode.height = i.fontSize * o;
  const r = this.bgNode.addComponent(cc.Graphics);
  r.arc(
    -this.textNode.width / 2,
    0,
    this.textNode.height / 2 + 20,
    0.5 * Math.PI,
    1.5 * Math.PI,
    !0,
  );
