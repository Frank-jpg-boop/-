...
import $roomLockMask from './RoomLockMask';
...
e.prototype.unlock = function () {
  if (!this._isUnlock) {
    ...
    const t = $battleMgr.default.instance.getCurScene().level;
...
e.prototype.gmCreateEnemy = function (t, e, n) {
  ...
  if (i) {
    for (
      ...
      const c = $cfg.default.instance.dataEnemy.getById(t);
...
e.prototype.initCreateEnemy = function () {
  ...
  if (e) {
    const n = cc.v2(this.node.x + this.node.width / 2, this.getGroundY());
    const i = !1;
    const o = null;
    ...
    if ("" != o) {
      o.split("|").forEach(function (o) {
        ...
        for (
          ...
          const f = $cfg.default.instance.dataEnemy.getById(s);
          $actorMgr.default.instance.createActor({
    ...
    if (i) {
      const r = cc.v2(this.node.width / 2, this.node.height / 2);
      r.x += 50;
      r.y += 30;
...
e.prototype.initRoomUnlockRange = function () {
  ...
  this._exData.unlockPointIds.forEach(function (e) {
    const n = $battleMgr.default.instance.getCurScene().level.path.getPoint(e);
    $unitMgr.UnitMgr.instance.createUnit({
...
e.prototype.onPathInitComplete = function () {
  ...
  if (e) {
    ...
    this._exData.pathPointIds.forEach(function (n) {
      const i = e.level.path.getPoint(n);
      if (i) {
        if (i.pos.y < t.node.y) {
          return;
        }
...
e.prototype.onDestroy = function () {
  ...
  if (
    0 != $levelBattleData.levelBattleData.cfgStage.id ||
    (12 != this._cfgRoom.id && 22 != this._cfgRoom.id)
  ) {
    //
  } else {
    $eventManager.EventManager.instance.off(
...
e.prototype.init = function (t) {
  ...
  if (!this.isUnlock && !this._cfgRoom.isOut) {
    const e = cc.instantiate(this.pRoomLockMask);
