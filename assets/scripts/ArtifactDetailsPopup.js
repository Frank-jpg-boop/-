...
var R = (function (t) {
  ...
  e.prototype.initMyList = function () {
    for (
      var t = this, e = this._artifactData.chooseLv.split("|"), n = 0;
      n < e.length;
      ++n
    ) {
      var i = e[n];
    ...
    if (this._moveToItem) {
      ...
      this._moveToItem =
        this.mItemContent.children[this.mItemContent.childrenCount - 1];
    }
  ...
  e.prototype.initAttributes = function () {
    ...
    var s = $playerDataProxy.playerDataProxy.getArtifactLv(
      this._artifactData.id,
    );
    var c = a[s - 1];
    if (c) {
    ...
    var l = a[s];
    var u = $playerDataProxy.playerDataProxy.getArtifactUpGreadNeedNum(
      this._artifactData.id,
    );
    var p = $playerDataProxy.playerDataProxy.getArtifactUpGreadNeeItemId(
      this._artifactData.id,
    );
  ...
  e.prototype.onRemainsItemClick = function (t, e) {
    ...
    var c = $nodeUtil.default.nodeParentChangeLocalPos(
      e.item,
    ...
    if (e.getStage > $stageDataProxy.stageDataProxy.passStageId) {
      ...
      if (1 == e.cfgReward.getStageType) {
        ...
        (this.removeUI(),
          ...
          $globalPopupMgr.default.instance.showSurviveListPopup(
            e.getStage,
            !0,
          ));
      }
  ...
  e.prototype.onBtnUpGerad = function () {
    ...
    var e;
    var n = this;
    var i = $playerDataProxy.playerDataProxy.getArtifactLv(
      this._artifactData.id,
    );
    ...
    var o = $playerDataProxy.playerDataProxy.getArtifactUpGreadNeedNum(
      this._artifactData.id,
    );
    var r = $playerDataProxy.playerDataProxy.getArtifactUpGreadNeeItemId(
      this._artifactData.id,
    );
    ...
    $playerActionMgr.PlayerActionMgr.instance.triggerAction(
      $taskEnum.EPlayerActionType.WEAPON_UP,
    );
    ...
    if (this._moveToItem && this._moveToItem.isValid) {
      if (
        null ===
          (t = this._moveToItem.getComponent($artifactDetailsItem.default)) ||
        void 0 === t
      ) {
        a = void 0;
      } else {
    ...
    this._isScrollToItem = !0;
    for (
      var l = this.mSkillItems.children, u = !1, p = null, h = 0;
      h < l.length;
      ++h
    ) {
      var f = l[h];
      var m = null;
      if (
        null === (e = f.getComponent($artifactDetailsItem.default)) ||
        void 0 === e
      ) {
        m = void 0;
      } else {
